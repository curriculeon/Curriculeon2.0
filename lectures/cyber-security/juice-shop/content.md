# Juice Shop Project
* _Click [here](https://owasp.org/www-project-juice-shop/) to view the original OWASP Juice Shop project_
...
## Installation
* Click [here](https://juice-shop.herokuapp.com/#/) to view the live juice-shop application and begin the exercise
...
* [Bkimminich's Git-Page](https://bkimminich.gitbooks.io/pwning-owasp-juice-shop/content/)
