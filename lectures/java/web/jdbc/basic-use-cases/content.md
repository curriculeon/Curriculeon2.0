...
* _You can view the resulting class by clicking [here](https://github.com/curriculeon/jdbc.project-template/blob/master/src/main/java/com/github/curriculeon/ApplicationRunner.java)._
* _You can view the resulting project by clicking [here](https://github.com/curriculeon/jdbc.project-template)._