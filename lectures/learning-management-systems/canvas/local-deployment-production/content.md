...
* Execute the command below to install `curl`
...
* Execute the command below to install `python`

	```bash
	sudo apt-get -y install python
	```

* Execute the command below to install `software-properties-common`

	```bash
	sudo apt-get -y install software-properties-common
	```
	
* Execute the command below to add repository `ppa:brightbox/ruby-ng`
...
* Execute the command below to install `Postgres`
...
* Execute the commands below to set up a Canvas user inside of `Postgres`
...
* Execute the command below to install `Ruby 2.6`

	```bash
	sudo apt-get -y install ruby2.6 ruby2.6-dev zlib1g-dev libxml2-dev \
						libsqlite3-dev postgresql libpq-dev \
						libxmlsec1-dev curl make g++
	```

* Execute the command below to install `NodeJS`
...
* Execute the command below to install `npm`

	```bash
	sudo apt-get -y install npm
	```

* Execute the command below to install latest `npm`
...
* Execute the commands below to install `yarn`
	...
	sudo apt-get update && sudo apt-get -y install yarn=1.19.1-1
	```

	
* Execute the commands below to install `redis`
...
* Execute the command below to change branches to `stable`
...
* Execute the command below to install `bundler` and `yarn` dependencies

	```bash
	cd /var/canvas
	sudo gem install bundler --version 2.2.19
	bundle _2.2.19_ install --without pulsar --path vendor/bundle
	sudo yarn install
	```
...
* Execute the commands below to initialize settings files
	...
	```bash
	cd /var/canvas
	sudo cp config/dynamic_settings.yml.example config/dynamic_settings.yml
